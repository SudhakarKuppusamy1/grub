...
test_overflow (void)
{
   ...
   */
  {
    ...
    if (l != -4L)
      {
        grub_fatal (
                "ERROR: asn1_get_length_der overflow-small (l %ld len %d)\n", l, len);
        return;
      }
  }
   ...
   */
  {
    ...
    if (l != -4L)
      {
        grub_fatal (
                "ERROR: asn1_get_length_der overflow-large1 (l %ld len %d)\n", l, len);
        return;
      }
  }
   ...
   */
  {
    ...
    if (l != -2L)
      {
        grub_fatal (
                "ERROR: asn1_get_length_der overflow-large2 (l %ld len %d)\n", l, len);
        return;
      }
  }
}
