...
grub_pks_keystore_init (void)
{
   ...
   */
  read_sbvar_from_pks (0, PKS_SBVAR_DB, &pks_keystore.db, &pks_keystore.db_entries);
   ...
   */
  rc_dbx = read_sbvar_from_pks (0, PKS_SBVAR_DBX, &pks_keystore.dbx, &pks_keystore.dbx_entries);
