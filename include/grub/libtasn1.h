...
#define ASN1_MAX_ERROR_DESCRIPTION_SIZE 128
  ...
  extern ASN1_API int
  asn1_read_value_type (asn1_node_const root, const char *name, void *ivalue, int *len, unsigned int *etype);
  ...
  extern ASN1_API int
  asn1_read_tag (asn1_node_const root, const char *name, int *tagValue, int *classValue);
...
#define ASN1_MAX_TL_SIZE (ASN1_MAX_TAG_SIZE + ASN1_MAX_LENGTH_SIZE)
  ...
  extern ASN1_API int
  asn1_decode_simple_der (unsigned int etype, const unsigned char *der, unsigned int _der_len,
                          const unsigned char **str, unsigned int *str_len);

  extern ASN1_API int
  asn1_decode_simple_ber (unsigned int etype, const unsigned char *der, unsigned int _der_len,
  ...
  extern ASN1_API int
  asn1_copy_node (asn1_node dst, const char *dst_name, asn1_node_const src, const char *src_name);
  extern ASN1_API asn1_node
...
#define node_asn_struct                                                \
  _Pragma ("GCC warning \"'node_asn_struct' macro is deprecated, use " \
           "'asn1_node' instead.\"") asn1_node_st
#else
...
#if _ASN1_GCC_VERSION >= 30100
#define node_asn                                                            \
  _Pragma ("GCC warning \"'node_asn' macro is deprecated, use 'asn1_node' " \
           "instead.\"") asn1_node_st
#else
...
#if _ASN1_GCC_VERSION >= 30100
#define ASN1_TYPE                                                            \
  _Pragma ("GCC warning \"'ASN1_TYPE' macro is deprecated, use 'asn1_node' " \
           "instead.\"") asn1_node
#else
...
#define ASN1_TYPE_EMPTY                                                       \
  _Pragma ("GCC warning \"'ASN1_TYPE_EMPTY' macro is deprecated, use 'NULL' " \
           "instead.\"") NULL
#else
...
#define static_struct_asn                                                \
  _Pragma ("GCC warning \"'static_struct_asn' macro is deprecated, use " \
           "'asn1_static_node_st' instead.\"") asn1_static_node_st
#else
...
#define ASN1_ARRAY_TYPE                                                \
  _Pragma ("GCC warning \"'ASN1_ARRAY_TYPE' macro is deprecated, use " \
           "'asn1_static_node' instead.\"") asn1_static_node
#else
...
#define asn1_static_node_t                                                \
  _Pragma ("GCC warning \"'asn1_static_node_t' macro is deprecated, use " \
           "'asn1_static_node' instead.\"") asn1_static_node
#else
...
#define node_data_struct                                                \
  _Pragma ("GCC warning \"'node_data_struct' macro is deprecated, use " \
           "'asn1_data_node_st' instead.\"") asn1_data_node_st
#else
...
#define ASN1_DATA_NODE                                                    \
  _Pragma ("GCC warning \"'asn1_static_node_t' macro is deprecated, use " \
           "'asn1_static_node' instead.\"") asn1_data_node_st
#else
